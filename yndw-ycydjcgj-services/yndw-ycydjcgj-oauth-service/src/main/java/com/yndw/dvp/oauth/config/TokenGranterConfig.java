...
import com.yndw.dvp.oauth.granter.PwdImgCodeGranter;
...
public class TokenGranterConfig {
    ...
    private List<TokenGranter> getAllTokenGranters() {
        ...
        if (authenticationManager != null) {
            // 添加密码加图形验证码模式
            tokenGranters.add(new PwdImgCodeGranter(authenticationManager, tokenServices, clientDetailsService, requestFactory, validateCodeService,rsaPrivateKey));
        }
