...
@Getter
@Setter
public class XtZzxxTreeDto implements Serializable {
    private static final long serialVersionUID = -2928088309055447316L;
    ...
    private List<XtZzxxTreeDto> children = new ArrayList<>();
}
