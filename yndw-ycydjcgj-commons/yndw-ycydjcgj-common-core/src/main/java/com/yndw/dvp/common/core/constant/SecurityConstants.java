...
public interface SecurityConstants {
     ...
     * 默认的处理验证码的url前缀
     */
    String DEFAULT_VALIDATE_CODE_URL = "/yndw/oauth/yndw-ycydjcgj-oauth-service/V1/validataCode/genGifCode/";
     ...
     * 登录URL
     */
    String LOGIN_URL = "/yndw/oauth/yndw-ycydjcgj-oauth-service/V1/oauth2/login";
    /**
     * 登出URL
     */
    String LOGOUT_URL = "/yndw/oauth/yndw-ycydjcgj-oauth-service/V1/oauth2/logout";
    /**
     * 默认token过期时间(1小时)
     */
    Integer ACCESS_TOKEN_VALIDITY_SECONDS = 60 * 60; // 1小时
    /**
     * redis中授权token对应的key
     */
